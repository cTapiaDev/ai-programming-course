...
> (Pega aquí el prompt que usaste para que la IA entendiera el problema o planificara la solución)

2. **Prompt de Generación de Código:**
> (Pega aquí el prompt principal donde pediste la implementación técnica)

3. **Prompt de Corrección / Refinamiento:**
> (Si la IA falló al principio, ¿cómo se lo dijiste? Pega el prompt de corrección aquí)
