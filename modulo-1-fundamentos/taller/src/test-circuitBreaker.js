...
var resilient_client_1 = require("./resilient-client");
function testCircuitBreaker() {
    return __awaiter(this, void 0, void 0, function () {
        var i, result, resultOpen, resultHalfOpen, resultClosed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, resilient_client_1.getUserData)("invalid-user")];
                case 2:
                    result = _a.sent();
                    console.log("Intento ".concat(i, ":"), result);
                    _a.label = 3;
                case 3:
                    i++;
                    return [3 /*break*/, 1];
